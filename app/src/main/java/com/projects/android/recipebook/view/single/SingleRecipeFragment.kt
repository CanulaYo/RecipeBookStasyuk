                            ...
                            binding.apply {
                                ...
                                if (recipe!!.isCooked) {
                                    if (isCookedSingle.text.toString() != resources.getString(R.string.single_recipe_fragment_isCooked)) {
                                        isCookedSingle.text =
                                            resources.getString(R.string.single_recipe_fragment_isCooked)
                                        isCookedPictureSingle.setImageDrawable(
                                            AppCompatResources.getDrawable(
                                                requireContext(),
                                                R.drawable.is_cooked
                                            )
                                        )
                                    }
                                } else {
                                    if (isCookedSingle.text.toString() != resources.getString(R.string.single_recipe_fragment_isNotCooked)) {
                                        isCookedSingle.text =
                                            resources.getString(R.string.single_recipe_fragment_isNotCooked)
                                        isCookedPictureSingle.setImageDrawable(
                                            AppCompatResources.getDrawable(
                                ...
                                if (recipe!!.isVeg) {
                                    if (isVegSingle.text.toString() != resources.getString(R.string.single_recipe_fragment_isVeg)) {
                                        isVegSingle.text =
                                            resources.getString(R.string.single_recipe_fragment_isVeg)
                                    ...
                                    if (isVegSingle.text.toString() != resources.getString(R.string.single_recipe_fragment_isNotVeg)) {
                                        isVegSingle.text =
                                            resources.getString(R.string.single_recipe_fragment_isNotVeg)
                                        isVegPictureSingle.setImageDrawable(
                                            AppCompatResources.getDrawable(
                                    ...
                                    bindingIngredients.apply {
                                        ...
                                        if (ingredient.unitOfMeasure != UnitOfMeasure.TO_TASTE) {
                                            ...
                                            if (quantityIngredientItemSingle.text != UnitOfMeasure.TO_TASTE.toString()) {
                                                quantityIngredientItemSingle.text =
                                                    UnitOfMeasure.TO_TASTE.toString()
                                            }
                ...
                return when (menuItem.itemId) {
                    ...
                    R.id.edit_recipe -> {
                        findNavController().navigate(
                            SingleRecipeFragmentDirections.fromSingleRecipeFragmentToAddRecipeFragment(
                                singleRecipeViewModel.state.value!!.recipe!!.id
                            )
                        )
                        true
                    }
