...
class AddRecipeCheckErrors {
    ...
    companion object {
        ...
        fun checkIngredients(
            ...
            for ((index, ingredient) in ingredientsList.withIndex()) {
                if (!checkQuantityIngredientItem(
                        bindingIngredientsList[index]!!.quantityIngredientItemLayoutAdd,
                        ingredient.quantity,
                        ingredient.unitOfMeasure
                    ) || !checkNameIngredientItem(
                        bindingIngredientsList[index]!!.nameIngredientItemLayoutAdd,
                        ingredient.name
                    )
                ) check = false
            }
        ...
        fun checkQuantityIngredientItem(
            quantityIngredientItemLayoutAdd: TextInputLayout,
            quantity: String,
        ...
        fun checkNameIngredientItem(
            nameIngredientItemLayoutAdd: TextInputLayout,
            name: String
        ): Boolean {
            if (name.isBlank()) {
