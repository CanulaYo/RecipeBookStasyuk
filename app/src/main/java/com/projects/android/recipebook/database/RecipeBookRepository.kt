...
class RecipeBookRepository private constructor(
    context: Context,
    ...
    companion object {
        ...
        fun get(): RecipeBookRepository {
            return INSTANCE
                ?: throw IllegalStateException("RecipeBookRepository must be initialized")
        }
    }

    private val database: RecipeBookDatabase = Room.databaseBuilder(
